...
// https://github.com/bravohex/vue-simple-acl/blob/7edd4dc0322de01f91f53674a7d72893cc8f2c35/playground/src/main.ts#L77
export function provaAcl(app: App<Element>) {
  const acl = simpleAcl
  app.use(acl)
}
